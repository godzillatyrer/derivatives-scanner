...
export const LEARNING_CONFIG = {
  ...
  batchSize: 50,          // increased from 20 — need statistical significance
  maxHistory: 500,
  minWeight: 0.02,
  maxWeight: 0.25,
};

export const PAPER_TRADING_FEES = {
  takerFee: 0.00035,       // 0.035% Hyperliquid taker fee
  slippagePct: 0.0005,     // 0.05% simulated slippage per fill
};

export const SIGNAL_COOLDOWN_MS = 45 * 60 * 1000; // 45 min cooldown per coin after exit
